...
function AITutor({ embedded = false, promptSignal = null }) {
  ...
  const chat = useChatAssistant({
    ...
    fallbackReply: (trimmed) => generateTutorReply(trimmed),
    onError: () => toast.info('Showing the cached contextual reply', 'Generated by the deterministic intelligence engine.'),
  })
