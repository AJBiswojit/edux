/**
 * Exam API — AI Exam Conducting Agent (student).
 *
...
defineRoute('get', '/student/exam-agent/exams', () => ({ items: EXAM_AGENT_EXAMS }))

defineRoute('get', '/student/exam-agent/attempts', () => {
...
defineRoute('get', '/student/exam-agent/attempts/:id', ({ params }) => {
...
defineRoute('post', '/student/exam-agent/attempts', ({ body }) => {
