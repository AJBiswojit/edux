...
const AdminAttendanceAnalytics = lazy(() => import('@/pages/admin/AttendanceAnalytics'))
const AdminAssignmentAnalytics = lazy(() => import('@/pages/admin/AssignmentAnalytics'))
const AdminExamAnalytics = lazy(() => import('@/pages/admin/ExamAnalytics'))
...
const AdminAcademicAnalytics = lazy(() => import('@/pages/admin/AcademicAnalytics'))
const AdminPerformance = lazy(() => import('@/pages/admin/Performance'))
const AdminPlacements = lazy(() => import('@/pages/admin/Placements'))
